const SITE_DATA = {
  ...
  translations: {
    en: {
      ...
      "contact.subtitle": "I welcome conversations about trustworthy AIGC, generative model security, concept-level safety, uncertainty and calibration, and multimedia forensics.",
      ...
      "contact.topicsLabel": "Current interests",
      "contact.topic1": "Postdoctoral and faculty opportunities",
      "contact.topic2": "Research collaboration and joint projects",
      "contact.topic3": "Talks, visits, and academic exchange",
      "contact.emailTitle": "Email",
      "contact.profilesTitle": "Academic profiles",
      "footer.built": "Built as a static GitHub Pages site.",
      "footer.note": "Visitor statistics are shown as aggregate counts.",
      "footer.lastUpdated": "Last updated",
      "footer.updateHint": "Content revision date",
      "footer.back": "Back to top",
      "visitor.counterLabel": "Visitor statistics",
      "visitor.pageViews": "Page views (PV)",
      "visitor.uniqueVisitors": "Unique visitors (UV)",
      "visitor.counterHint": "View current IP location",
      "visitor.close": "Close visitor location panel",
      "visitor.modalKicker": "Visitor location",
      "visitor.modalTitle": "Current visitor IP location",
      "visitor.status.initial": "Open the visitor panel to load your public IP location.",
      "visitor.status.loading": "Loading the current visitor's IP location...",
      "visitor.status.loaded": "Approximate location loaded for the current visitor.",
      "visitor.status.error": "Unable to load the IP location right now. Please try again later.",
      "visitor.publicIp": "Public IP",
    ...
    zh: {
      ...
      "about.p2": "2025 年 9 月至 2026 年 8 月，我受国家留学基金委（CSC）卓越人才计划项目资助，在意大利米兰开展访问博士研究，由 Elena Ferrari 教授（IEEE/ACM Fellow）指导。访学期间，我还与米兰大学 Pierangela Samarati 教授（IEEE/ACM Fellow）和 Vincenzo Piuri 教授（IEEE Fellow）开展学术交流与合作，进一步拓展了在可信人工智能、安全与隐私方向的国际研究经历。",
      ...
      "contact.subtitle": "欢迎围绕可信 AIGC、生成模型安全、概念级安全、不确定性与校准以及多媒体取证开展交流。",
      "contact.availability": "已顺利完成博士学位论文答辩，预计于 2026 年 10 月获得博士学位。欢迎就博士后或高校教职机会与我联系。",
      "contact.topicsLabel": "交流方向",
      "contact.topic1": "博士后与高校教职机会",
      "contact.topic2": "科研合作与联合项目",
      "contact.topic3": "学术报告、访问与交流",
      "contact.emailTitle": "电子邮箱",
      "contact.profilesTitle": "学术主页",
      "footer.built": "本主页通过 GitHub Pages 静态部署。",
      "footer.note": "访客数据以汇总统计形式展示。",
      "footer.lastUpdated": "最新更新",
      "footer.updateHint": "内容修订日期",
      "footer.back": "返回顶部",
      "visitor.counterLabel": "访客统计",
      "visitor.pageViews": "页面浏览量（PV）",
      "visitor.uniqueVisitors": "独立访客数（UV）",
      "visitor.counterHint": "查看当前 IP 位置",
      "visitor.close": "关闭访客位置面板",
      "visitor.modalKicker": "访客位置",
      "visitor.modalTitle": "当前访客的 IP 位置信息",
      "visitor.status.initial": "打开访客面板后将加载你的公网 IP 位置信息。",
      "visitor.status.loading": "正在加载当前访客的 IP 位置信息……",
      "visitor.status.loaded": "已加载当前访客的大致位置信息。",
      "visitor.status.error": "暂时无法加载 IP 位置信息，请稍后重试。",
      "visitor.publicIp": "公网 IP",
      "visitor.location": "位置",
      "visitor.organization": "网络组织",
      "visitor.timezone": "时区",
