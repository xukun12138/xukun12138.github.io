const SITE_DATA = {
  ...
  translations: {
    en: {
      ...
      "contact.emailHint": "For research discussions, collaboration, and position-related enquiries.",
      "contact.profilesTitle": "Academic profiles",
      "contact.profilesHint": "Publication records, peer-review profiles, code, and professional networks.",
    ...
    zh: {
      ...
      "contact.emailHint": "用于研究交流、科研合作及职位相关联系。",
      "contact.profilesTitle": "学术主页",
      "contact.profilesHint": "论文记录、评审档案、代码与学术社交主页。",
